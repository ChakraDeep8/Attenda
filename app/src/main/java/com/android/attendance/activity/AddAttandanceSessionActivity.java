...
public class AddAttandanceSessionActivity<AddAttandanceActivity> extends Activity {
	...
	private String[] branchString = new String[] { "CSE","IT","AIML","CSE-DS","ME","EC","B-Voc","EE","ECE"};
	private String[] yearString = new String[] {"1st","2nd","3rd","4th"};
	private String[] subject1stString = new String[] {"BS","C"};
	private String[] subject2ndString = new String[] {"OS","Algorithm"};
	private String[] subject3rdString = new String[] {"DS","CN"};
	private String[] subject4thString = new String[] {"Project","Elective"};

	private String[] subjectFinal = new String[] {"BS","C","OS","Algorithm","DS","CN","NS","Project","Elective"};
